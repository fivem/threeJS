						...
						if(obj.map!= undefined && typeof(obj.map)!=='string'){
							...
							materials.push(
								new THREE.MeshBasicMaterial( 
									 (obj.texture.direction=='top'?singleMaterial:commonMaterial)
								 ),
								new THREE.MeshBasicMaterial(
									(obj.texture.direction=='bottom'?singleMaterial:commonMaterial)
								),
								new THREE.MeshBasicMaterial(
									(obj.texture.direction=='left'?singleMaterial:commonMaterial)
								),
								new THREE.MeshBasicMaterial(
									(obj.texture.direction=='right'?singleMaterial :commonMaterial)
								),
								new THREE.MeshBasicMaterial(
									(obj.texture.direction=='front'?singleMaterial :commonMaterial)
								),
								new THREE.MeshBasicMaterial(
									(obj.texture.direction=='behind'?singleMaterial :commonMaterial)
								)
							);
							o = new THREE.Mesh(
